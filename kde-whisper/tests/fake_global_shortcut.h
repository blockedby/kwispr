...
public:
    ...
    QKeySequence externalChangeBeforeNextRead;
    bool externalChangeBeforeNextReadArmed = false;
    ...
    QList<QKeySequence> shortcut(const QAction *) const override
    {
        ...
        if (that->externalChangeBeforeNextReadArmed) {
            that->externalChangeBeforeNextReadArmed = false;
            that->changeExternally(that->externalChangeBeforeNextRead);
        }
    ...
    void changeExternallyBeforeNextRead(const QKeySequence &shortcut)
    {
        externalChangeBeforeNextRead = shortcut;
        externalChangeBeforeNextReadArmed = true;
    }
};
