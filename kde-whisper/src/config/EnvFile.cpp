...
QMap<QString, QString> EnvFile::defaults() {
    return {
        ...
        {QStringLiteral("KWISPR_WHISPER_PROMPT"), QString()},
        {QStringLiteral("KWISPR_VOCABULARY"), QString()},
        {QStringLiteral("KWISPR_STOP_DELAY_MS"), QStringLiteral("0")},
        {QStringLiteral("KWISPR_PRESERVE_AUDIO_TAIL"), QStringLiteral("0")},
